...
app.get('/api/health', (req, res) => {
    res.json({ status: 'OK', message: 'Cryptogen Backend API is running' });
});
...
app.listen(PORT, async () => {
    console.log(`🚀 Cryptogen Backend Server running on port ${PORT}`);
    console.log(`📡 Using cryptogen certificates (no CA required)`);
    try {
        await buildWallet();
        ...
        console.log('💡 Make sure Hyperledger Fabric network is running');
    }
});